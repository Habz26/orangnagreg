...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a class="btn btn-info text-black" href="{{ route('user.create') }}">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0 text-white">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    <form action="{{ route('user.destroy', $item->id) }}" method="post" onsubmit="return confirm('Yakin ingin menghapus data ini?');">
                                        @csrf
                                        @method('DELETE')
                        ...
                        @if ($items->isEmpty())
                        <tr>
                            <td colspan="5" class="text-center fst-italic text-white">Belum ada data user.</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
