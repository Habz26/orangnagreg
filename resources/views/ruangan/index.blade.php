...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="mb-0 text-white">Daftar Ruangan</h3>
        @auth
        <a class="btn btn-info text-black" href="{{ route('ruangan.create') }}">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0 text-white">
                    ...
                    <tbody>
                        ...
                        @if ($items->isEmpty())
                        <tr>
                            <td colspan="5" class="text-center fst-italic text-white">Belum ada data ruangan.</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
