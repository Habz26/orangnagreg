...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="mb-0 text-white">Daftar Barang</h3>
        @auth     
        <a class="btn btn-info text-black" href="{{ route('barang.create') }}">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0 text-white">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="d-flex justify-content-center gap-2">
                                    <a class="btn btn-success btn-sm" href="{{ route('barang.edit', $item->id) }}">Edit</a>
                                    <form action="{{ route('barang.destroy', $item->id) }}" method="post" onsubmit="return confirm('Yakin ingin menghapus data ini?');">
                                        @csrf
                                        @method('DELETE')
                        ...
                        @if ($items->isEmpty())
                        <tr>
                            <td colspan="10" class="text-center fst-italic text-white">Belum ada data barang.</td>
                        </tr>
                        @endif
                    </tbody>
                </table>
