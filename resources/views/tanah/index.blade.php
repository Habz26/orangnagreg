...
@section('content')
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h3 class="mb-0 text-white">Daftar Tanah</h3>
            @auth
                <a class="btn btn-info text-black" href="{{ route('tanah.create') }}">
                        ...
                        <tbody>
                            @foreach ($items as $item)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $item->nama_tanah }}</td>
                                    <td class="text-center">{{ $item->kode_tanah }}</td>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-2">
                                                <a class="btn btn-success btn-sm"
                                                    href="{{ route('tanah.edit', $item->id) }}">Edit</a>
                            ...
                            @if ($items->isEmpty())
                                <tr>
                                    <td colspan="@auth 6 @else 5 @endauth" class="text-center fst-italic text-white">Belum
                                        ada data tanah.</td>
                                </tr>
                            @endif
                        </tbody>
